...
//	obj.moveToElement(e).build().perform();
//	Thread.sleep(3000);
//	//inspect one of the link and click on it
//	driver.findElement(By.xpath("//*[@id=\"nav-al-wishlist\"]/a[4]/span")).click();
//	
		Actions obj = new Actions(driver);
		// drag and drop

		// click an hold for sometime on the element to be moved to another location,
...
//clickAndHold() --event:  it will click on an element and hold it for certain time
		...
		// build() and perform() methods are used to perform the series of events on the
		// page
